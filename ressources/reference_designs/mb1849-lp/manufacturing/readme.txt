...
* @version 1.0
* @date      22-June-2022 
* @brief      Reference_Design_STM32WL_BGA73_4L_IPD_LowPower board manufacturing files package
******************************************************************************
...
========================
	...
	Manufacturing files and differents BOM variants for the board MB1849-LP
